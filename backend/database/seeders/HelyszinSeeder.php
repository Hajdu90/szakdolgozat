...
class HelyszinSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $helyszinek = [
            ...
            [
                'orszag' => 'Brazília',
                'varos' => 'Rio de Janeiro',
                'szallashely_tipus' => 'vendeghaz',
                'leiras' => 'Vendégház Copacabana strand közelében.',
                'cim' => 'Av. Atlântica 1702',
                'ferohely' => 7,
            ],
            [
                'orszag' => 'Argentína',
            ...
            [
                ...
                'varos' => 'Kairó',
                'szallashely_tipus' => 'hotel',
                'leiras' => 'Hotel kilátással a piramisokra.',
                'cim' => 'Pyramids Road 12',
                'ferohely' => 16,
            ],
            [
                'orszag' => 'Dél-Afrika',
                'varos' => 'Fokváros',
                'szallashely_tipus' => 'apartman',
                'leiras' => 'Apartman a Table Mountain közelében.',
                'cim' => '15 Long Street',
                'ferohely' => 6,
            ],
            [
                ...
                'varos' => 'Sydney',
                'szallashely_tipus' => 'hotel',
                'leiras' => 'Hotel az Operaház közelében.',
                'cim' => '1 Macquarie St',
                'ferohely' => 15,
            ],
            [
